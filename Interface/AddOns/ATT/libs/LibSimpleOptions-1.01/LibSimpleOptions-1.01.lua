...
do
	local function dropDown_SetValue(self, value)
		self.value = value
		L_UIDropDownMenu_SetSelectedValue(self, value)
		self.changeFunc(value)
	end
	...
	function panelMeta:MakeDropDown(...)
		...
		dropDown.initialize = function() L_UIDropDownMenu_Initialize(dropDown, function(self, level, menuList)
		...
		if WotLK then
		    ...
		    L_UIDropDownMenu_JustifyText(dropDown, "CENTER")					
		...
		L_UIDropDownMenu_SetSelectedValue(dropDown, current)
