...
function COMP:Print(addon, feature)
	...
	print(KUI.Title..L["has |cffff2020disabled|r "]..feature..L[" from "]..addon..L[" due to incompatiblities."])
...
function COMP:ModulePrint(addon, module)
	...
	print(KUI.Title..L["has |cffff2020disabled|r "]..module..L[" due to incompatiblities with: "]..addon)
