...
local function SetupCVars()
	...
	if not KUI:IsDeveloper() or not (IsAddOnLoaded("!BugGrabber") and IsAddOnLoaded("BugSack")) then
...
local function SetupChat()
	...
	E.db["chat"]["panelHeight"] = 162
	E.db["chat"]["panelWidthRight"] = 400
	E.db["chat"]["panelHeightRight"] = 162
	...
	KUI:SetMoverPosition("RightChatMover", "BOTTOMRIGHT", E.UIParent, "BOTTOMRIGHT", -10, 31)
	KUI:SetMoverPosition("LeftChatMover", "BOTTOMLEFT", E.UIParent, "BOTTOMLEFT", 10, 31)
...
function KUI:SetupLayout(layout)
	...
	KUI:SetMoverPosition("ElvUIBagMover", "BOTTOMRIGHT", E.UIParent, "BOTTOMRIGHT", -10, 31)
	KUI:SetMoverPosition("ElvUIBankMover", "BOTTOMLEFT", E.UIParent, "BOTTOMLEFT", 10, 31)
	...
	E.db["nameplates"]["healthFontSize"] = 12
	...
	E.db["nameplates"]["targetGlow"] = "style8"
	E.db["nameplates"]["glowColor"] = {r = 249/255, g = 96/255, b = 217/255}
	...
	--E.db["nameplates"]["units"]["HEALER"]["powerbar"]["text"]["enable"] = true
	--E.db["nameplates"]["units"]["HEALER"]["showName"] = true
	--E.db["nameplates"]["units"]["HEALER"]["visibility"]["showInCombat"] = false
	E.db["nameplates"]["units"]["HEALER"]["showLevel"] = true
	--E.db["nameplates"]["units"]["HEALER"]["castbar"]["iconPosition"] = "LEFT"
	...
	E.db["nameplates"]["units"]["FRIENDLY_NPC"]["buffs"]["filters"]["priority"] = {} -- We must reset the filter priority before we apply ours.
	...
	E.db["nameplates"]["cooldown"]["fonts"]["fontSize"] = 10
...
function KUI:SetupUnitframes(layout)
	...
	if KUI.IsDeveloper() and IsAddOnLoaded("WeakAuras") then
	...
	if not KUI.IsDeveloper() and IsAddOnLoaded("WeakAuras") then
...
function KUI:SetupActionbars(layout)
	...
	if layout == "dps" then
		...
		KUI:SetMoverPosition("ElvAB_6", "BOTTOM", E.UIParent, "BOTTOM", 0, 31)		
	...
	elseif layout == "healer" then
		...
		--	Movers - HEALER
		--]]----------------------------------
		KUI:SetMoverPosition("ElvAB_1", "BOTTOM", E.UIParent, "BOTTOM", -124, 31)
		KUI:SetMoverPosition("ElvAB_2", "BOTTOM", E.UIParent, "BOTTOM", 124, 31)
		KUI:SetMoverPosition("ElvAB_3", "BOTTOM", E.UIParent, "BOTTOM", -124, 62)
		KUI:SetMoverPosition("ElvAB_4", "BOTTOMLEFT", E.UIParent, "BOTTOMLEFT", 411, 8)
		KUI:SetMoverPosition("ElvAB_5", "BOTTOMRIGHT", E.UIParent, "BOTTOMRIGHT", -411, 8)
		KUI:SetMoverPosition("ElvAB_6", "BOTTOM", E.UIParent, "BOTTOM", 124, 62)
...
function KUI:SetupDts(layout)
	...
	if IsAddOnLoaded("ElvUI_EnhancedCurrency") then
	...
	if IsAddOnLoaded("Masque") and IsAddOnLoaded("Masque_KlixUI") then
		...
		E.db["KlixUI"]["datatexts"]["middle"]["width"] = 371
	end
...
local function SetupAddons()
	...
	if IsAddOnLoaded('ElvUI_SLE') then
		KUI:LoadSLEProfile()
		tinsert(addonNames, 'Shadow & Light')
	end
...
KUI.installTable = {
	...
	["Pages"] = {
		[1] = function()
			...
			PluginInstallFrame.Desc2:SetText(L["Please click the continue button to go onto the next step."])
