-- Credits goes to Benik for this mod!!
...
local function CreateSplashScreen()
	local f = CreateFrame('Frame', 'KlixUISplashScreen', E.UIParent)
	f:Size(300, 150)
	f:SetPoint('CENTER')
...
function KUI:SplashScreen()
	...
	if E.db.KlixUI.installed == true then C_TimerAfter(6, ShowSplashScreen) end
