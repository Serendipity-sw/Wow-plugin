...
function LP:UpdateTooltip()
	...
	if E.db.KlixUI.locPanel.tooltip.ttinst and T:DoesZoneHaveInstances(zoneText) then 
		GameTooltip:AddLine(" ")
	...
	if E.db.KlixUI.locPanel.tooltip.ttrecinst and T:HasRecommendedInstances() and level >= 15 then
		GameTooltip:AddLine(" ")
