...
local function Datatexts()
			...
			credits = {
				...
				args = {
					tukui = {
						...
						type = "description",
						fontSize = "medium",
						name = format("|cff00c0faBenikUI - Benik|r & |cffff7d0aMerathilisUI - Merathilis|r & |cff9482c9Shadow&Light - Darth Predator|r & |cff9382c9Lockslap|r"),
					},
				},
			},
			intro = {
			...
			general = {
				...
				args = {
					...
					timeSize = {
						...
						type = "range",
						name = L["Time Size"],
						desc = L["Change the size of the Time DataText."],
						min = 0.1, max = 3, step = 0.1,
						get = function(info) return E.db.KlixUI.datatexts.timeSize end,
						set = function(info, value) E.db.KlixUI.datatexts.timeSize = value; E:StaticPopup_Show("PRIVATE_RL"); end,
					},
				},
			},
			panels = {
					...
					chat = {
						...
						args = {
							...
							editBoxPosition = {
								...
								disabled = function() return not E.db.KlixUI.datatexts.chat.enable end,
								get = function(info) return E.db.KlixUI.datatexts.chat[ info[#info] ] end,
								set = function(info, value) E.db.KlixUI.datatexts.chat[ info[#info] ] = value; KUI:GetModule('Chat'):UpdateAnchors() end,
							},
							strata = {
								order = 8,
								type = "select",
								name = L["Frame Strata"]..E.NewSign,
								get = function(info) return E.db.KlixUI.datatexts.chat[ info[#info] ] end,
	...
	--local i = 0
	--for pointLoc, tab in pairs(P.KlixUI.datatexts.panels) do
		--i = i + 1
...
local function CurrencyDT()
	...
	E.Options.args.KlixUI.args.modules.args.datatexts.args.currencyDT = {
		...
		args = {
			...
			token = CreateCurrencyConfig(12, L["Show WoW Token Price"]..E.NewSign, 'WoWToken'),
			...
			delete = {
				...
				set = function(info, value) 
					...
					E.PopupDialogs['KUI_CONFIRM_DELETE_CURRENCY_CHARACTER'].text = format(L["Are you sure you want to remove |cff1784d1%s|r from currency datatexts?"], name..(realm and "-"..realm or ""))
