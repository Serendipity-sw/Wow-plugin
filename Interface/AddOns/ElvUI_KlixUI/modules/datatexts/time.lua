local KUI, E, L, V, P, G, _ = unpack(select(2, ...))
...
function Update(self, t)
	...
	if AmPm == -1 then
		self.text:FontTemplate(nil, self.db.fontSize*E.db.KlixUI.datatexts.timeSize, self.db.fontOutline)
...
DT:RegisterDatatext('Time (KUI)', {"UPDATE_INSTANCE_INFO"}, OnEvent, Update, Click, OnEnter, OnLeave)