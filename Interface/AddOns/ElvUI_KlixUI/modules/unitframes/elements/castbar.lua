...
local KUIC = E:NewModule('KuiCastbar', 'AceTimer-3.0', 'AceEvent-3.0')
...
function KUIC:CastBarHooks()
	...
	for _, unit in pairs(units) do
		...
		if castbar then
			...
			hooksecurefunc(castbar, "PostChannelStart", KUIC.PostCast)
		end
	end
...
E:RegisterModule(KUIC:GetName(), InitializeCallback)