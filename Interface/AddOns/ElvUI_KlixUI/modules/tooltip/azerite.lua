...
function AT_BuildTooltip(self)
	if not E.db.KlixUI.tooltip.azerite.enable or IsAddOnLoaded("AzeriteTooltip") then return end
...
function AT:Initialize()
	...
	GameTooltip:HookScript("OnTooltipSetItem", AT_BuildTooltip)
	ItemRefTooltip:HookScript("OnTooltipSetItem", AT_BuildTooltip)
	ShoppingTooltip1:HookScript("OnTooltipSetItem", AT_BuildTooltip)
	WorldMapTooltip.ItemTooltip.Tooltip:HookScript('OnTooltipSetItem', AT_BuildTooltip)
	WorldMapCompareTooltip1:HookScript("OnTooltipSetItem", AT_BuildTooltip)
	EmbeddedItemTooltip.ItemTooltip.Tooltip:HookScript("OnTooltipSetItem", AT_BuildTooltip)
end
