--All credits belong to Benik for this awesome AFK screen, not taking any credits myself whatsoever.
local KUI, E, L, V, P, G = unpack(select(2, ...))
local AFK = E:GetModule('AFK')

local format, random, lower, tonumber, date, floor, unpack = string.format, random, string.lower, tonumber, date, floor, unpack
...
local function Initialize()
	...
	AFK.AFKMode.top.time:SetTextColor(unpack(E["media"].rgbvaluecolor))
	...
	AFK.AFKMode.top.date:SetTextColor(unpack(E["media"].rgbvaluecolor))
	...
	AFK.AFKMode.top.Status:SetStatusBarColor(unpack(E["media"].rgbvaluecolor))
	...
	AFK.AFKMode.bottom.eversion:SetTextColor(unpack(E["media"].rgbvaluecolor))
	...
	AFK.AFKMode.bottom.mversion:SetTextColor(unpack(E["media"].rgbvaluecolor))
