			...
			minimap = {
				...
				args = {
					general = {
						...
						args = {
							...
							blink = {
								order = 2,
								type = "toggle",
								name = L["Minimap Blink"],
								desc = L["Shows the minimap blinking when a mail or a calendar invite is available."],
							},
							hideincombat = {
								order = 3,
								type = "toggle",
					...
					buttons = {
						...
						disabled = function() return (COMP.PA and _G.ProjectAzilroka.db["SquareMinimapButtons"] or COMP.SLE and E.private.sle.minimap.mapicons.enable) end,
						hidden = function() return (COMP.PA and _G.ProjectAzilroka.db["SquareMinimapButtons"] or COMP.SLE and E.private.sle.minimap.mapicons.enable) end,
						args = {
							credits = {
								order = 1,
								type = "group",
								...
								args = {
									tukui = {
										...
										type = "description",
										fontSize = "medium",
										name = format("|cFF16C3F2Square|r |cFFFFFFFFMinimap Buttons|r - |cFF16C3F2Project|r|cFFFFFFFFAzilroka|r"),
									},
								},
							},
							enable = {
					...
					cardinalPoints = {
						order = 5,
						type = "group",
						name = L["Cardinal Points"]..E.NewSign,
						disabled = function() return IsAddOnLoaded("ElvUI_CompassPoints") end,
						hidden = function() return IsAddOnLoaded("ElvUI_CompassPoints") end,
