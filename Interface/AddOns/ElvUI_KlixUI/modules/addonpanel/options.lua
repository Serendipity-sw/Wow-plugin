...
local function AddonPanelTable()
	E.Options.args.KlixUI.args.modules.args.addonpanel = {
		type = "group",
		order = 2,
		name = AP.modName..E.NewSign,
		disabled = function() return COMP.PA and _G.ProjectAzilroka.db["stAddonManager"] end,
		hidden = function() return COMP.PA and _G.ProjectAzilroka.db["stAddonManager"] end,
			...
			credits = {
				...
				args = {
					tukui = {
						...
						type = "description",
						fontSize = "medium",
						name = format("|cFF16C3F2st|r|cFFFFFFFFAddonManager|r - |cFF16C3F2Project|r|cFFFFFFFFAzilroka|r"),
					},
				},
			},
			general = {
				...
				args = {
					...
					FontCustomColor = {
						...
						type = "color",
						name = L["Font Color"],
						disabled = function() return E.db.KlixUI.addonpanel.FontColor == 1 or E.db.KlixUI.addonpanel.FontColor == 3 end,
						get = function(info)
...
tinsert(KUI.Config, AddonPanelTable)