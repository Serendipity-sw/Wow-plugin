...
local function styleGarrisonTemplates()
	...
	function KS:GarrisonFollowerCombatAllySpellTemplate(Button)
		S:HandleTexture(Button.iconTexture, Button)
	end
	...
	function KS:GarrisonMissionPageCostFrameTemplate(Button)
		S:HandleTexture(Button.CostIcon, Button)
	end
	...
	hooksecurefunc(GarrisonFollowerTabMixin, "OnLoad", KS.GarrisonFollowerTabMixin_OnLoad)
end
