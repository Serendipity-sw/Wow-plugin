...
if KUI._Compatibility["DejaCharacterStats"] or IsAddOnLoaded('ElvUI_SLE') then return end
--Credits: Dejablue
...
KA.ScrollframeParentFrame = CreateFrame("Frame", nil, CharacterFrameInsetRight)
KA.ScrollframeParentFrame:SetSize(198, 352)
KA.ScrollframeParentFrame:SetPoint("TOP", CharacterFrameInsetRight, "TOP", 0, -4)

--Scrollframe 
KA.ScrollFrame = CreateFrame("ScrollFrame", nil, KA.ScrollframeParentFrame)
KA.ScrollFrame:SetPoint("TOP")
KA.ScrollFrame:SetSize(KA.ScrollframeParentFrame:GetSize())

--Scrollbar 
KA.Scrollbar = CreateFrame("Slider", nil, KA.ScrollFrame, "UIPanelScrollBarTemplate") 
...
KA.ScrollChild = CreateFrame("Frame", nil, KA.ScrollFrame)
