...
local microBar = CreateFrame("Frame", KUI.Title.."MicroBar", E.UIParent)
...
function MB:CreateMicroBar()
	microBar = CreateFrame("Frame", KUI.Title.."MicroBar", E.UIParent)
	...
	--Config
	local configButton = CreateFrame("Button", nil, microBar)
	...
	configButton:SetScript("OnClick", function(self) if InCombatLockdown() then return end E:ToggleConfig() end)
	...
	questButton:SetScript("OnClick", function(self) if InCombatLockdown() then return end _G["ToggleQuestLog"]() end)
	...
	timer:SetScript("OnFinished", function(self, requested)
		local euTime = date("%H|cFF999999:|r%M")
		local ukTime = date("%I|cFF999999:|r%M")
	...
	--Bug
	local bugButton = CreateFrame("Button", nil, microBar)
	...
	bugButton:SetScript("OnClick", function(self) if InCombatLockdown() then return end E:StaticPopup_Show("BUG_REPORT", nil, nil, "https://discord.gg/GbQbDRX") end)
	
	--Support
	local supportButton = CreateFrame("Button", nil, microBar)
	...
	supportButton:SetScript("OnClick", function(self) if InCombatLockdown() then return end ToggleHelpFrame() end)
	
	E:CreateMover(microBar, "KUI_MicroBarMover", L["MicroBarMover"], nil, nil, nil, 'ALL,ACTIONBARS,KLIXUI', nil, "KlixUI,modules,actionbars,microBar")
end
